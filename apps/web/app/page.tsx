...
import { DEMO_DAILY_PITCHES, DEMO_DAILY_PUZZLE } from './mockDailyPuzzle';
  ...
  return (
    <main className="page-shell">
      <section className="daily-card">
        ...
        <DailyInningGame puzzle={DEMO_DAILY_PUZZLE} demoPitches={DEMO_DAILY_PITCHES} players={baseballPlayers} />
      </section>
    </main>
  );
}
