...
3. Follow `tasks/plans/resolved-at-bat-comparison.md` next, beginning with the portable independent-population comparison contract/service as a separate PR before provider/API/UI work. Supabase is the provider; engine owns scoring; React renders.
