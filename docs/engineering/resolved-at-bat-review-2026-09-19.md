...
R6 and R8 are separate follow-ups; do not bundle them into comparison or a generic hardening PR. R7's extractions should accompany the behavior they clarify. Held PRs #161/#174 remain references only and must not merge unchanged.
