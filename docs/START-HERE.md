...
- Current main before the R5 follow-up is `2fa9c61a8eb84d007bebdf2df89e40c70be230c2` (PR #211, R6 malformed-save decoding). Push CI #778 completed successfully; production deployment `dpl_DeAjxY54ddhzBLfHe3GEcktZyGxb` is `READY` on that exact SHA with the canonical alias attached. No Supabase change was part of R6.
