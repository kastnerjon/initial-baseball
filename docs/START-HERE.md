...
5. R5 bounded pending-delivery recovery and R6 malformed-save decoding are repaired. Track R7 and R8 as separate bounded follow-ups; continue physical-device/editorial QA. Archive/local history follows the explicit future launch epoch. Remove public Reset before launch.
