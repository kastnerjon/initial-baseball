...
Hitter career/season reveal ordering is complete (`tasks/plans/hitter-reveal-column-order.md`). The next scoped concern is hint-4 stat composition and supported pitcher saves.
