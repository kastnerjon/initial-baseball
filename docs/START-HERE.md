...
Next complete delayed/failed/stale-read plus ordinary browser/mobile trigger-to-visible verification, then treat comparison backend work as beta-complete and move the center of gravity to presentation work such as issue #216 scorecard/share AVG.
