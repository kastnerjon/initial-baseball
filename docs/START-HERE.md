...
5. R6 malformed-save decoding is repaired behind a dedicated persisted-save codec with missing/unreadable/unusable/loaded states. Track R5, R7 and R8 as separate bounded follow-ups; continue physical-device/editorial QA. Archive/local history follows the explicit future launch epoch. Remove public Reset before launch.
