...
> September 26 follow-up: before any public v4 activation or persisted v4 production result, the owner finalized v4 as 4/3/2/1/0.5/0. The original 4/3/2/1/0/-1 draft documented by the first implementation checkpoint is superseded by `tasks/plans/points-v4-half-walk-zero-strikeout.md`.
...
- **In scope:** v4 outcome values, wrong-guess semantics, Give Up/K semantics, live points remaining, half-point nine-at-bat range/step, focused version-boundary tests, and canonical documentation.
...
- **Acceptance checks:** HR/3B/2B/1B/BB/K score 4/3/2/1/0.5/0; wrong guesses one and two do not deduct; a third wrong guess is K; Give Up uses the same K score; nine HRs score 36; nine Ks score 0; all nine at-bats are played; v3 remains 0..63 and remains `CURRENT_DAILY_RULESET_VERSION`.
