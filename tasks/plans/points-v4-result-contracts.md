...
- **Acceptance checks:** v4 correct outcomes score 4/3/2/1/0 regardless of wrong guesses 0–2; strikeout/Give Up score -1; nine-HR completion derives 36; nine-K completion derives -9; v3 still derives 0..63 under its existing deduction formula; exact-version mismatch rejects; v3/v4 records remain distinct idempotency populations; points-v1/v2/legacy remain unsupported result submissions.
