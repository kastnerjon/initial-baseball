...
The evidence covers exact-main CI/production identity, recent runtime route health, Supabase migration/RPC privilege posture, build-size deltas and hidden-answer QA.
...
3. separate browser/network/server/provider contributions where current evidence permits;
