...
24. Issue #216 scorecard/share presentation is implemented in the web layer: the private completed scorecard and spoiler-safe copied output derive one optional whole-game AVG view from the existing completed-comparison state, preserving 0–1 withholding / 2–9 Early AVG / 10+ AVG and adding no new comparison calculation or backend request. Per-AB share averages and onset-of-AB display remain out of scope.
