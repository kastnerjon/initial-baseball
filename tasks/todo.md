...
- [ ] Compose the server permanent-puzzle reader with the materializer into one archive puzzle source/runtime seam, without adding public navigation or choosing the launch epoch.
