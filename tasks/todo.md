...
- [x] Implement independent-population portable comparison contract/service: one-slot count/point-sum reads, separate completed score buckets/histogram, null empty averages, strict-lower ties, and `sourceReadAt` freshness metadata.
