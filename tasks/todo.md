...
- [ ] Extend result and comparison contracts/storage for exact-version `points-v4` populations, including -1..4 AB points, -9..36 completed totals, offset histograms, strict-lower comparison, and preserved v3 validation. Keep migration/provider work and browser activation in bounded follow-ups.
