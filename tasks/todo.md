...
- [ ] Browser 6D activation proof/reconciliation: exact merge-SHA production deploy, multi-tab takeover proof, one controlled production AB insert + exact retry/readback, runtime-error scan, and final canonical-doc declaration before collection is considered live.
