...
### 4D. Daily Nine resolved-AB comparison — read activation complete; browser/UI next
...
- [ ] Add the bounded comparison request-lifecycle controller: independent at-bat/completed channels, semantic key + generation/request fencing, replacement/invalidation abort, and stale success/error/settled suppression.
