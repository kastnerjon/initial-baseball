...
### 4D. Daily Nine resolved-AB comparison — performance evidence complete; activation next
...
- [ ] Make the explicit default-off comparison activation decision; preserve immediate own-result rendering and keep comparison I/O off gameplay's critical path.
