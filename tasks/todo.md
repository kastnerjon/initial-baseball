...
- [ ] Omit one terminal Jr./Sr. token from generated initials while preserving player names, aliases, interior tokens, and II/III; implementation and verification are complete, with merge/deployment pending a Pacific Daily date boundary so beta clue/result identities cannot mix within the same day. Scope: `tasks/plans/terminal-generational-suffix-initials.md`.
