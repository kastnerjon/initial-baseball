...
- [ ] Decompose comparison handler long-tail time between authoritative-puzzle loading and managed comparison-provider work before making any optimization change.
