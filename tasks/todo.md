...
- [x] R2: fence gameplay Guess/Give Up responses, errors and cleanup across reset/restore/ownership changes.
...
- [ ] Add mounted React lifecycle regressions for R3/R4 when their ownership/effect boundary is implemented. R2 is covered by deterministic async request-controller regressions because this repo currently has no DOM/test-renderer harness; introducing one is a separate external-dependency decision.
