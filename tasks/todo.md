...
- [ ] Add the mounted React rerender/StrictMode lifecycle regression in the R4 owning fix PR; R3 has deterministic coordinator/degraded-owner/write-policy regressions, while the happy-path phone proof does not exercise re-bootstrap interleavings.
