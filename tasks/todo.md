...
- [ ] Add the separate completed-game comparison: final scorecard context, whole-game average and strict-lower finisher percentage with the settled 20-completion threshold and current-read refresh on restore.
