...
- [ ] Align hint 4's stat order with the full reveal and include supported pitcher `SV`. Reconcile actual structured hint/reveal coverage, not the legacy bWAR config label.
