...
- [ ] In a separate reviewed Supabase PR, widen result codecs/constraints and comparison RPC/provider bounds for v4, preserve v3 checks/populations, verify RLS/privileges/readback, and keep browser activation out.
