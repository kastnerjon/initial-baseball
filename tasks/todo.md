...
- [ ] Omit one terminal Jr./Sr. token from new initials while preserving player names, aliases, interior tokens, II/III, and original initials for beta dates before September 28, 2026. Deploy and verify the date-aware code before that Pacific day begins; move the cutover forward if rollout is delayed. Scope: `tasks/plans/terminal-generational-suffix-initials.md`.
