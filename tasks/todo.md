...
- [x] R2: fence gameplay Guess/Give Up responses, errors and cleanup across reset/restore/ownership changes with synchronous request epochs and identity-checked success/error/finally.
