...
- [x] 4D-1: define the provider-neutral sufficient-statistics read port and pure Daily Nine aggregate service; keep points-v3 scoring in the engine and SQL/provider code semantics-free.
