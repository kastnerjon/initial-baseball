...
- [ ] Implement web/server read-only comparison routes and authoritative request composition in the current bounded PR; keep representative performance/cache work later.
