...
- [ ] Make the portable Daily comparison domain version-aware for v3/v4, including v4 -1..4 AB observations, -9..36 completed totals, offset histogram semantics, and strict-lower beat calculations without changing any Supabase provider yet.
