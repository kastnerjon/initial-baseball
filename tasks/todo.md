...
- [ ] R7B: reduce `DailyInningGame` browser orchestration concentration as a separate checkpoint; do not turn it into a generic state-machine rewrite.
