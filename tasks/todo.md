...
- [ ] R7C decision checkpoint: review the remaining `DailyInningGame` concentration after R7B and extract another cohesive current responsibility only if it materially improves ownership; do not create a generic state machine for line-count alone.
