...
- [ ] Define the versioned shared comparison HTTP response/freshness contract in the current PR; then implement web/server read-only routes as the next PR, with representative performance/cache work later.
