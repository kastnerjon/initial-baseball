...
- [ ] Split the provider boundary into local Supabase client/repository setup, `client.rpc(...)` wait, and local decode before changing provider behavior.
