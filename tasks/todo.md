...
- [ ] Extend browser persistence/delivery/scorecards/comparison presentation for finalized v4 and perform a separate safe public-default cutover without migrating v3 saves.
