...
- [ ] G3B: in a separate reviewed PR, widen the comparison RPCs, Supabase comparison decoder/repository port and server read boundary for signed v4 aggregates while preserving v3 reads and service-role-only function access.
